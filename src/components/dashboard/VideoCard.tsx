...
export const VideoCard: React.FC<VideoCardProps> = ({
  ...
  return (
    <Card className="group overflow-hidden bg-background hover:bg-accent/5 transition-all duration-200">
      <div className="aspect-video relative overflow-hidden">
        ...
        />
        <div className="absolute top-2 right-2 px-1 py-0.5 bg-black/80 text-white text-xs rounded">
          {duration}
        </div>
